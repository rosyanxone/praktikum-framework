    ...
    <div class="container py-8 flex">
        ...
        <div class="basis-1/4 flex flex-col gap-1">
            ...
            <div class="flex flex-row">
                <a href="https://www.instagram.com/informatika.unmul/" class="group p-4 rounded-full hover:bg-slate-800 transition ease-in">
                ...
                <a href="https://www.youtube.com/@informatikaunmul9999" class="group p-4 rounded-full hover:bg-slate-800 transition ease-in">
